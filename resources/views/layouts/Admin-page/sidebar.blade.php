    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
            ...
            <li class="nav-item">
                <a class="nav-link" data-toggle="collapse" href="{{ route('news.index') }}" aria-expanded="false"
            ...
            <li class="nav-item">
                <a class="nav-link" data-toggle="collapse" href="/admin/announcement" aria-expanded="false"
            ...
            <li class="nav-item">
                <a class="nav-link" data-toggle="collapse" href="/admin/user" aria-expanded="false"
                    aria-controls="auth">
