                ...
                <div class="card tale-bg">
                    <div class="card-people mt-auto">
                        ...
                        <div class="weather-info">
                            <div class="d-flex">
                                <div>
                                    <!-- Logo cuaca, seperti ikon matahari -->
                                    <h2 class="mb-7 font-weight-normal" style="margin-top: -30px">
                                        <i class="icon-sun mr-2"></i>31<sup>C</sup>
                                    </h2>
                                </div>
                                <div class="ml-2" style="margin-top: -30px;"> <!-- Menambahkan margin-top untuk menggeser ke atas -->
